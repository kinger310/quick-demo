...
public class A01 {
    ...
    public static void main(String[] args) throws NoSuchFieldException, IllegalAccessException, IOException {
        ...
        /*
            ...
            四个接口 ： EnvironmentCapable, MessageSource, ApplicationEventPublisher, ResourcePatternResolver
        ...
        Component1 pub = context.getBean(Component1.class);
        pub.register();

        /*
            4. 学到了什么
                a. BeanFactory 与 ApplicationContext 并不仅仅是简单接口继承的关系, ApplicationContext 组合并扩展了 BeanFactory 的功能.
                例如 国际化功能Message, 资源功能Resources， 环境变量功能， 事件发布订阅功能（解耦）
                b. 又新学一种代码之间解耦途径
