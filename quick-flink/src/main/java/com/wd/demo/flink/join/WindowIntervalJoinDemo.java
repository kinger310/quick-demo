...
public class WindowIntervalJoinDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        OutputTag<Tuple2<String, Integer>> left = new OutputTag<>("left", Types.TUPLE(Types.STRING, Types.INT));
        OutputTag<Tuple3<String, Integer, Integer>> right = new OutputTag<>("right", Types.TUPLE(Types.STRING, Types.INT, Types.INT));
