 ...
 */
public class Demo03_OuterClass_0 {
    private byte[] outerData;

    public Demo03_OuterClass_0(byte[] data) {
        this.outerData = data;
    }
    ...
    private static InnerClass getInnerClass() {
        Demo03_OuterClass_0 outer = new Demo03_OuterClass_0(new byte[2*1024*1024]);
        InnerClass inner = outer.new InnerClass();
        // outerData设置为null，也不会回收
